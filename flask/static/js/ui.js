...
window.addEventListener('load', () => {
    ...
    document.getElementById('play_simulator').addEventListener('click', (e) => {
        e.preventDefault();
        e.stopPropagation();
        const button = document.getElementById('play_simulator');
        if (button.classList.contains('play')) {
            ...
            if (Editor.animationId !== null) {
                window.cancelAnimationFrame(Editor.animationId);
                Editor.animationId = null;
                const playSimulator = document.getElementById('play_simulator');
                playSimulator.classList.remove('stop');
                playSimulator.classList.add('play');
            }
        }
    });
